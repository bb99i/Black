...
print([[
 ...
 [[[__[[\. [[[     ,[[ '[[,  [[[         [[[[[/'  
 $$""""Y$$ $$'    c$$$cc$$$c $$$        _$$$$,    
_88o,,od8Po88oo,.__888   888,`88bo,__,o,"888"88o, 
""MRSOFI" """"DevS00f4   ""`   "MR-SoOFi"DRG "DRG"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/bb99i/Files_Black/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1782576192,1914379745,119541395}   
...
local hash = database:sismember(bot_id.."SOFI7:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSOFI(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif tonumber(user_id) == tonumber(1914379745) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'SOFI7:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "Bk55i")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"𝑩𝒍𝒂𝑪𝒌➧بـــلاڪ ")  
...
os.execute('wget https://raw.githubusercontent.com/bb99i/Black/main/Black.lua')
...
-------------
if text == "⅌ تحديثات سورس بلاك ⅌" and DevSOFI(msg) then  
local updatech =[[
...
{{text = '𝑩𝒍𝒂𝑪𝒌➧بـــلاڪ', url="t.me/Bk55i"}},
}
...
usertext = '\n *⅌︙العضو »* ['..result.title_..'](t.me/'..(username or 'Bk55i')..')'
status  = '\n *⅌︙تم ترقيته مطور*'
...
usertext = '\n *⅌︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
status  = '\n *⅌︙تم ترقيته مطور*'
...
if Black1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⅌︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Bk55i')..') \n ⅌︙'..Black1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⅌︙العضو : {["..data.first_name_.."](T.ME/Bk55i)}\n ⅌︙["..Black_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⅌︙عذرا » {["..data.first_name_.."](T.ME/Bk55i)}\n ⅌︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
bnnaGet(msg.sender_user_id_, SOFI7_name)
end
...
⅌︙𝑩𝒍𝒂𝑪𝒌➧بـــلاڪ
◉━━━━━━𝘽𝙆━━━━━━◉
⅌︙[𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒉𝒂𝒏𝒏𝒆𝒍](t.me/Bk55i)
⅌︙[𝑺𝒐𝒖𝒓𝒄𝒆 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](t.me/BB55i)
⅌︙[𝑩𝒐𝒕 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓](t.me/bk33i)
⅌︙[𝑻𝒘𝒔 𝑩𝒍𝒂𝑪𝒌](t.me/Bk55bot)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Bk55i&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if text == "منو مطور السورس" or text == "منو المطور" or text == "مطور السورس" or text == "مطور بلاك" then  
local s00f4 = GetBio(tonumber(1782576192),msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '〝 مطــور ســورس بــلاڪ 〞', url="t.me/BB55i"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"ا")
  database:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تغ","تغير الايدي")
 database:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تغ")
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⅌︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Bk55i')..') \n *⅌︙تـم قفـل الدردشه *')
end,nil)   
...
if text == 'تفعيل كت' or text == 'تفعيل كت تويت' and CoSu(msg) then   
if database:get(bot_id..'KT:Tuet'..msg.chat_id_) then
Text = '* ⅌︙تم تفعيل امر كت تويت*'
database:del(bot_id..'KT:Tuet'..msg.chat_id_)  
else
Text = '* ⅌︙بالتاكيد تم تفعيل امر كت تويت*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل كت' or text == 'تعطيل كت تويت' and CoSu(msg) then  
if not database:get(bot_id..'KT:Tuet'..msg.chat_id_) then
database:set(bot_id..'KT:Tuet'..msg.chat_id_,true)  
Text = '\n *⅌︙تم تعطيل امر كت تويت*'
else
Text = '\n *⅌︙بالتاكيد تم تعطيل امر كت تويت*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⅌︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Bk55i')..') \n *⅌︙تـم قفـل التاك بالكتم *')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."SOFI7:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"*انتظر دقيقه من فضلك*")
end
database:setex(bot_id..'SOFI7:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevSOFI(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/bb99i/Files_Black/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⅌︙اهلا بك في متجر ملفات بلاك\n ⅌︙ملفات السورس ↓\n◉━━━━━━𝘽𝙆━━━━━━◉\n\n"
local TextE = "\n◉━━━━━━𝘽𝙆━━━━━━◉\n ⅌︙علامة تعني { ✔️ } ملف مفعل\n ⅌︙علامة تعني { ✖ } ملف معطل\n ⅌︙قناة سورس بلاك ↓\n".." ⅌︙[اضغط هنا لدخول](t.me/Bk55i) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/bb99i/Files_Black/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "Black-TEAM")
...
database:del(bot_id..'SOFI7:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '* ⅌︙تم مسح المنظفين*')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'SOFI7:MN:TF'..msg.chat_id_)
t = "\n ⅌︙قائمة المنظفين \n◉━━━━━━𝘽𝙆━━━━━━◉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⅌︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
status  = '\n *⅌︙تم ترقيته منظف*'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n *⅌︙العضو »* ['..result.title_..'](t.me/'..(username or 'Bk55i')..')'
status  = '\n *⅌︙تم ترقيته منظف*'
texts = usertext..status
else
...
database:sadd(bot_id..'SOFI7:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⅌︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
status  = '\n *⅌︙تم ترقيته منظف*'
...
function start_function(extra, result, success)
database:srem(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⅌︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n *⅌︙العضو »* ['..result.title_..'](t.me/'..(username or 'Bk55i')..')'
status  = '\n *⅌︙تم تنزيله من المظفين*'
texts = usertext..status
else
...
database:srem(bot_id..'SOFI7:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⅌︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
status  = '\n *⅌︙تم تنزيله من المظفين*'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⅌︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⅌︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'Bk55i')..')'..'\n ⅌︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'SOFI7:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'SOFI7:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."SOFI7:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."SOFI7:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "*⅌︙تم مسح "..k.." من الوسائط الموجوده*"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."SOFI7:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."SOFI7:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'SOFI7:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:set(bot_id.."Bk55i:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*⅌︙تم تفعيل الانستا*')
database:set(bot_id.."Bk55i:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Bk55i:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Bk55i:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⅌︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Bk55i:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Bk55i:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
--  عود اخمط وهوبز ع العالم كول تطويري صوفـي مطور سورس دراكون ..
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Bk55i')..')'
local iduser = result.sender_user_id_
...
local Text =[[
𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙀𝙇𝙄𝙏𝙀 𝙄𝙉𝙁𝙊  💭
*◉━━━━━━𝘽𝙆━━━━━━◉*
*〝 𝟭 〞◂ اوامر الحمايه .*
*〝 𝟮 〞◂ اوامر تعطيل ~ تفعيل .*
*〝 𝟯 〞◂ اوامر ضع ~ اضف  .*
*〝 𝟰 〞◂ اوامر مسح ~ حذف .*
*〝 𝟱 〞◂ اوامر تنزيل+رفع+التغير .*
*〝 𝟲 〞◂ اوامر الكروب .*
*〝 𝟳 〞◂ اوامر التحشيش .*
*〝 𝟴 〞◂ اوامر مطور البوت .*
*〝 𝟵 〞◂ اوامر مطور الاساسي .*
*〝 𝟭𝟬 〞◂ اوامر الاعضاء .*
*◉━━━━━━𝘽𝙆━━━━━━◉*
⅌︙[𝑩𝒍𝒂𝑪𝒌➧بـــلاڪ](t.me/Bk55i)
]]
...
keyboard.inline_keyboard = {
{
{text = '〝 𝟭 〞', callback_data="/help1"},{text = '〝 𝟮 〞', callback_data="/help2"},{text = '〝 𝟯 〞', callback_data="/help3"},
},
{
{text = '〝 𝟰 〞', callback_data="/help4"},{text = '〝 𝟱 〞', callback_data="/help5"},
},
{
{text = '〝 𝟲 〞', callback_data="/help6"},{text = '〝 𝟳 〞', callback_data="/help7"},{text = '〝 𝟴 〞', callback_data="/help8"},
},
{
{text = '〝 𝟵 〞', callback_data="/help9"},{text = '〝 𝟭𝟬 〞', callback_data="/help10"},
},
{
{text = '𝑩𝒍𝒂𝑪𝒌➧بـــلاڪ', url="t.me/Bk55i"},
},
